...
(function () {
  ...
  async function sendMessage(text) {
    ...
    if (messageCount >= MAX_MESSAGES) {
      appendMessage("assistant", "Vi har pratat ett tag nu! För fler frågor, kontakta oss på hej@1753skincare.com eller ring 0732-30 55 21.");
      return;
    }
    ...
    try {
      ...
      hideTyping();
      appendMessage("assistant", "Oj, något gick fel. Försök igen eller kontakta oss på hej@1753skincare.com.");
    }
  }
