...
export const LEGAL_TERMS_SV: LegalDoc = {
  ...
  sections: [
    ...
    {
      h: "4. Leverans",
      html: `<p>Vi skickar alla ordrar med Postnord Varubrev. Normal leveranstid är 2–5 arbetsdagar inom Sverige. Fri frakt vid köp över 700 kr; i övrigt tillkommer en fraktavgift på 49 kr.</p>`,
    },
    {
      h: "5. Ångerrätt",
